...
const TableComparisonProductivityAll: React.FC<{
  data: Data2G4GModel[];
  tech: string;
  selectedKPIs: string[];
  onFilteredComparisonDataChange?: (data: any[]) => void;
}> = ({ data, tech, selectedKPIs, onFilteredComparisonDataChange }) => {
  ...
  const { comparisonData } = useComparisonDataProductivityAll(data, tech, beforeRange, afterRange);
...
export default TableComparisonProductivityAll;
